...
public interface IOrderRepository
{
    ...
    Task<(IReadOnlyList<Order>, int totalCount)> GetPagedForAdminAsync(int page, int pageSize, DateOnly? from, DateOnly? to, OrderStatus? status, string? customerEmail, int? orderNumber, CancellationToken ct);
